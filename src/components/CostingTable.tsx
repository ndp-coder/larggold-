    ...
    <div className="py-8 px-3 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <div style={{ border: '1px solid rgba(255,255,255,0.3)', background: 'rgba(255,255,255,0.82)', backdropFilter: 'blur(8px)' }}>
          <div className="px-3 sm:px-5 py-3" style={{ borderBottom: '1px solid #cccccc' }}>
                    ...
                    >
                      <td className="px-3 sm:px-5 py-3 sm:py-4 w-24 sm:w-44">
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(11px, 2.5vw, 15px)', fontWeight: 900, color: '#111111', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                            {r.metal === 'gold' ? 'GOLD' : r.metal === 'silver' ? 'SILVER' : 'INR'}
                          </span>
                        </div>
                      </td>
                      <td className="px-2 sm:px-5 py-3 sm:py-4 text-center">
                        <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(16px, 4vw, 28px)', fontWeight: 800, color: '#111111' }}>
                          {fmt(r.col1, r.metal)}
                        </span>
                      </td>
                      <td className="px-2 sm:px-5 py-3 sm:py-4 text-center">
