...
export default function Footer({ setPage }: FooterProps) {
  ...
  return (
    <footer
      ...
      style={{
        background: 'linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.92)), url("https://bolt.new/api/upload/files%2F6010405-2026-04-14T11-57-33-543Z-files_6010405-2026-04-14T11-48-41-726Z-image.png?projectId=65593657") center/cover no-repeat',
      }}
      id="contact"
    >
